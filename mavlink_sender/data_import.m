...
%% load data
importdata('datarecording_1432037066.csv')

load test4_100s_q0.025_wind4.mat
...
h1=plot3(object_x,object_y,object_z,'-g');
...
ylabel('North(x) (m)')
zlabel('Up(z) (m)')
legend([h1,h2,h3],'Linear Connection GPS Points','Antenna Estimation','Real Flight Path')
