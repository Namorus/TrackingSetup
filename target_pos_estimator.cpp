...
// 0.1 calculation of turn rate omega ----------------------------------------------
	double v_total2=xhat(1)^2+xhat(3)^2+xhat(5)^2; //calculate total velocity^2

	double omega = tan(phi)*gravity/sqrt(v_total2);

// 0.2 calculation q according to wind ----------------------------------------------

	double v_wind = sqrt(v_total2)-abs(v_air);
	float a_LS=0.065;
	float b_LS=0.065;
...
F_c << 0 << 1 << 0 << 0 << 0 << 0 << endr
	<< 0 << gravity*xhat(1)*xhat(3)*tan(phi)/(xhat(1)^2+xhat(3)^2+xhat(5)^2)^(3./2.) << 0 << gravity*xhat(3)^2*tan(phi)/(xhat(1)^2+xhat(3)^2+xhat(5)^2)^(3./2.)-gravity*tan(phi)/sqrt(v_total2) << 0 << gravity*xhat(3)*xhat(5)*tan(phi)/(xhat(1)^2+xhat(3)^2+xhat(5)^2)^(3./2.) << endr
	<< 0 << 0 << 0 << 1 << 0 << 0 << endr
    << 0 << gravity*tan(phi)/sqrt(v_total2)-gravity*xhat(1)^2*tan(phi)/(xhat(1)^2+xhat(3)^2+xhat(5)^2)^(3./2.) << 0 << -gravity*xhat(1)*xhat(3)*tan(phi)/(xhat(1)^2+xhat(3)^2+xhat(5)^2)^(3./2.) << 0 << -gravity*xhat(1)*xhat(5)*tan(phi)/(xhat(1)^2+xhat(3)^2+xhat(5)^2)^(3./2.) << endr
	<< 0 << 0 << 0 << 0 << 0 << 1 << endr
	<< 0 << 0 << 0 << 0 << 0 << 0 << endr;
...
vec b(6);
b   << 0 << endr
	 << -4.*gravity*xhat(3)*cos(phi)^2./((cos(2.*phi)+1)^2.*sqrt(v_total2)) << endr
	 << 0 << endr
	 << 4*gravity*xhat(1)*cos(phi)^2./((cos(2.*phi)+1)^2.*sqrt(v_total2)) << endr
	 << 0 << endr
	 << 0 << endr;
